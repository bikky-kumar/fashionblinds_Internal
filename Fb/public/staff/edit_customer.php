...
<a class="back_link" href="<?php echo url_for('public/staff/index.php?id='. h($id)); ?>"> &laquo; Back to Admin</a> 
</div>
...
<div class="form_container">
  <form action="<?php echo url_for('public/staff/edit_customer.php?id='. h($id)); ?>" method = "post">
    ...
    <input type="text" id="address" name="address" value= "<?php echo h($address) ?>">

    <label for="date">Date</label><br />   
    <input type="Date" id="date" name="start_date" value= "<?php echo h($contact_date) ?>"><br /><br />

    <label for="date">Processed Date</label><br />   
    <input type="Date" id="processed_date" name="processed_date" value= "<?php echo h($processed_date) ?>"><br /><br />
